...
def get_customer_accounts(client):
    """
    Grabs all customer accounts in one banking object.

    There is currently an error in the aggcat library with parsing
    the XML object and accessing all accounts in the object.
    """
